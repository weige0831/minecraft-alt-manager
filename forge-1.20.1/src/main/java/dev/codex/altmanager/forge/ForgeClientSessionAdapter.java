...
public final class ForgeClientSessionAdapter implements ClientSessionAdapter {
    ...
    public SessionSwitchResult switchTo(Object minecraftClient, MinecraftAccount account) {
        if (!(minecraftClient instanceof Minecraft)) {
            return SessionSwitchResult.failure(SessionSwitchStatus.FAILED, "Expected Minecraft for Forge 1.20.1");
        }
    ...
    private void clearLikelyProfileKeyCaches(Minecraft client) {
